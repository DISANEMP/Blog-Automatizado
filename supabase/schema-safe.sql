...
create table if not exists public.price_snapshots (
  ...
  coupon text,
  price_status text default 'estimate' check (price_status in ('real', 'simulated', 'estimate', 'expired')),
  shipping_note text,
...
create table if not exists public.articles (
  ...
  type text not null,
  status text default 'draft' check (status in ('draft', 'preview', 'approved', 'published')),
  category text,
